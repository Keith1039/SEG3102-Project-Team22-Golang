...
func ParameterCreate(values ParametersForm, errors map[string]string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/parameters.templ`, Line: 48, Col: 123}
		}
		...
		if errors["Minimum"] != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/parameters.templ`, Line: 50, Col: 61}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/parameters.templ`, Line: 55, Col: 123}
		}
		...
		if errors["Maximum"] != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/parameters.templ`, Line: 57, Col: 61}
			}
		...
		if errors["Conversion"] != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/parameters.templ`, Line: 61, Col: 60}
			}
